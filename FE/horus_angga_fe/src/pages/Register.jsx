  ...
  return (
    <div className="bg-slate-900 h-screen w-full flex justify-center items-center">
      <div className="bg-white w-96 h-3/4 rounded-lg">
        <h1 className='font-semibold text-[2rem] text-center mt-2'>Register</h1>
        <form onSubmit={handleSubmit} className="w-full p-4 flex flex-col">
          ...
          <button type='submit' className='bottom-0 bg-blue-500 shadow-xl text-white font-semibold py-2 rounded-xl transition-all transform hover:scale-95 duration-300'>Register</button>
        </form>
      </div>
    </div>
  );
